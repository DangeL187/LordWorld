void gui() {
    std::string p_lvl = std::to_string(player_lvl);
    std::string p_hp = std::to_string(player_hp);
    std::string p_mp = std::to_string(player_mp);
    std::string p_xp = std::to_string(player_xp);
    std::string p_hr = std::to_string(hp_regen);
    std::string p_mr = std::to_string(mp_regen);
