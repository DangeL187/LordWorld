...
protected:
		...
		void setWeaponStats(auto& game, auto& inv_items) {
            ...
            case 1:
                ...
                break;
            default:
		    				game.AnimationWeaponSprite = game.InventoryItemEmptySprite;
        ...
        switch (inv_items[28]) { //Shield stats
            case 2:
                game.AnimationShieldSprite = game.AnimationIronShieldSprite;
								game.AnimationShieldSprite.setTextureRect(IntRect(0, 0, 1, 1));
              	armor_shield = 1;
              	break;
            default:
                game.AnimationShieldSprite = game.InventoryItemEmptySprite;
                game.AnimationShieldSprite.setTextureRect(IntRect(0, 0, 1, 1));
                armor_shield = 0;
        }
